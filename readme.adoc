= Руководство по стилю оформления кода на Руби
:idprefix:
:idseparator: -
:sectanchors:
:sectlinks:
...
[quote, Офицер Алекс Мёрфи / Робот-полицейский]
____
...
* https://github.com/rubocop/ruby-style-guide/blob/master/README.adoc[английский (исходная версия)]
* https://github.com/HassanTC/ruby-style-guide/blob/master/README-EgAr.md[арабский (египетский)]
* https://github.com/CQBinh/ruby-style-guide/blob/master/README-viVN.md[вьетнамский]
* https://github.com/alemohamad/ruby-style-guide/blob/master/README-esLA.md[испанский]
* https://github.com/JuanitoFatas/ruby-style-guide/blob/master/README-zhTW.md[китайский традиционный]
* https://github.com/JuanitoFatas/ruby-style-guide/blob/master/README-zhCN.md[китайский упрощенный]
* https://github.com/dalzony/ruby-style-guide/blob/master/README-koKR.md[корейский]
* https://github.com/gauthier-delacroix/ruby-style-guide/blob/master/README-frFR.md[французкский]
* https://github.com/rubensmabueno/ruby-style-guide/blob/master/README-PT-BR.md[португальский (бразильский)]
* https://github.com/arbox/ruby-style-guide/blob/master/readme.adoc[русский (данный документ)]
* https://github.com/fortissimo1997/ruby-style-guide/blob/japanese/README.ja.md[японский]
...
Уберите отсюда "кроме их собственного" &mdash; и они будут, наверное, правы...
____
...
TIP: UTF-8 стала стандартной кодировка для исходного кода с версии Руби 2.0.

=== Табуляция или пробелы? [[tabs-or-spaces]]

Используйте пробелы для задания отступов. Никаких знаком табуляции!

=== Отступы [[spaces-indentation]]

Используйте два *пробела* на  уроверь отступа (т.е. мягкую табуляцию).
...
Модуль проверки кода https://www.jetbrains.com/ruby/[RubyMine] https://confluence.jetbrains.com/display/RUBYDEV/RubyMine+Inspections[частично основывается] на этом руководстве.
...
Данная работа опубликована на условиях лицензии
