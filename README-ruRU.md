...
[Ruby on Rails 3 & 4: Руководство по стилю оформления](https://github.com/arbox/rails-style-guide/blob/master/README-ruRU.md).
...
* <a name="no-for-loops"></a> Используйте оператор `for` только в случаях, когда
  ...
  стоит применять итераторы. Оператор `for` реализуются при помощи `each` (таким
...
[RuboCop](https://github.com/bbatsov/rubocop) - это утилита проверки стиля
