= :blue_book: Руководство по стилю оформления кода на Руби

> Коллективно создаваемое руководство по стилю оформления кода на https://www.ruby-lang.org/ru/[Руби]

Это руководство по оформлению кода на https://www.ruby-lang.org/ru/[Руби] дает передовые рекомендации.
...
:green_book: https://github.com/arbox/rails-style-guide/blob/master/README-ruRU.md[Rails: руководство по стилю оформления].
